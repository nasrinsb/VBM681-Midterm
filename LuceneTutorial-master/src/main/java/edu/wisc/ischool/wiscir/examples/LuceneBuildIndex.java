...
public class LuceneBuildIndex {
    ...
    public static void main( String[] args ) {
        try {
            ...
            String pathCorpus = "C:\\Users\\Nasrin\\Desktop\\Programlar\\VBM\\JAVA\\YENİ SON ÇALIŞMA\\LuceneTutorial-master\\example_corpus.gz";
            String pathIndex = "C:\\Users\\Nasrin\\Desktop\\Programlar\\VBM\\JAVA\\YENİ SON ÇALIŞMA\\LuceneTutorial-master\\example_index_lucene";
          ...
          //config.setSimilarity( new BM25SimilarityOriginal() );
	       ...
	       // LMJelinekMercerSimilarity similarity = new LMJelinekMercerSimilarity(0.1f);            
	      // config.setSimilarity( new LMJelinekMercerSimilarity(0.1f) );
                    
         // config.setSimilarity( new AxiomaticF1EXP() );
